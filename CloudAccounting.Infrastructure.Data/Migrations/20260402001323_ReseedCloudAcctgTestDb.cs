...
namespace CloudAccounting.Infrastructure.Data.Migrations
{
    ...
    public partial class ReseedCloudAcctgTestDb : Migration
    {
                    ...
                    BEGIN TRANSACTION;
                        BEGIN TRY
						   ...
						   INSERT INTO dbo.GL_COMPANY 
								(CONAME, COADDRESS, COCITY, COZIP, COPHONE, COFAX, COCURRENCY, DOMAINNAME) VALUES
								( 'BTechnical Consulting','123 Main Street','Dallas','75214','(972) 555-6666','(972) 555-5558','USD', 'btechnical-consulting.com' );
						   INSERT INTO dbo.GL_COMPANY 
								(CONAME, COADDRESS, COCITY, COZIP, COPHONE, COFAX, COCURRENCY, DOMAINNAME) VALUES
								( 'Contoso Ltd.','21477 Munger Blvd','Dallas','75214','(972) 555-6666','(972) 555-5558','USD', 'contoso.com' );
							INSERT INTO dbo.GL_COMPANY 
								(CONAME, COADDRESS, COCITY, COZIP, COPHONE, COFAX, COCURRENCY, DOMAINNAME) VALUES
								( 'Fabrikam Inc.','123 Main Street','Dosoto','75214','(972) 555-6666','(972) 555-5558','USD', 'fabrikam.com' );
						   INSERT INTO dbo.GL_COMPANY 
								(CONAME, COADDRESS, COCITY, COZIP, COPHONE, COFAX, COCURRENCY, DOMAINNAME) VALUES
								( 'Adventure Works','21477 Islamic Blvd','Dallas','75214','(972) 555-6666','(972) 555-5558','USD', 'adventure-works.com' );                        
							...
							INSERT INTO Role (Id, Name, NormalizedName) VALUES ('1', 'AppAdmin', 'APPADMIN');
							INSERT INTO Role (Id, Name, NormalizedName) VALUES ('2', 'CompanyAdmin', 'COMPANYADMIN'); 
							INSERT INTO Role (Id, Name, NormalizedName) VALUES ('3', 'User', 'USER');
							...
							VALUES (
								'52506af3-b7fc-48b9-8adf-5f43ad3f1e6a',
								0,
								'Application',
								'Administrator',
								0,
								...
								'ADMIN@CLOUDACCTG.COM', 
								1, 
								'AQAAAAIAAYagAAAAEJgJ6HdOnNdmmkg0wOHEaINjfKu7eATnnZlryayGIGDkuzB6Ucjo/HvhjRc/h/fIYQ==', 
								'MXS6BIWD4UAUWXG2LICUG4IMWWNADGAA', 
								'0d42ded0-bf24-47f5-8e43-dac62cf32948', 
								'5555555555', 
								1, 
								0, 
								1, 
							...
							VALUES (
								'4d2bd389-afc3-4451-a8cb-1b65a7456ba8',
								1,
								'Henry',
								'Gonzales',
								2024,
								7,
								1, 
								'hgonzales@btechnical-consulting.com', 
								'HGONZALES@BTECHNICAL-CONSULTING.COM', 
								'hgonzales@btechnical-consulting.com', 
								'HGONZALES@BTECHNICAL-CONSULTING.COM', 
								1, 
								'AQAAAAIAAYagAAAAEJgJ6HdOnNdmmkg0wOHEaINjfKu7eATnnZlryayGIGDkuzB6Ucjo/HvhjRc/h/fIYQ==', 
								'MXS6BIWD4UAUWXG2LICUG4IMWWNADGAA', 
								'b2414e5d-7794-40e4-8c58-7eeeb4feb4a1', 
								'5555555555', 
								1, 
								0, 
								1, 
							...
							VALUES (
								'70f74d66-896b-4401-b433-df93563a0738',
								1,
								'Daniel',
								'Quale',
								2024,
								7,
								0, 
								'dquale@btechnical-consulting.com', 
								'DQUALE@BTECHNICAL-CONSULTING.COM', 
								'dquale@btechnical-consulting.com', 
								'DQUALE@BTECHNICAL-CONSULTING.COM', 
								1, 
								'AQAAAAIAAYagAAAAEJgJ6HdOnNdmmkg0wOHEaINjfKu7eATnnZlryayGIGDkuzB6Ucjo/HvhjRc/h/fIYQ==', 
								'MXS6BIWD4UAUWXG2LICUG4IMWWNADGAA', 
								'f4d6a941-db82-4e2a-9f0c-3fa57d618949', 
								'5555555555', 
								1, 
								0, 
								1, 
							...
							INSERT INTO UserRoles (UserId, RoleId) VALUES ('52506af3-b7fc-48b9-8adf-5f43ad3f1e6a', 1);
							INSERT INTO UserRoles (UserId, RoleId) VALUES ('4d2bd389-afc3-4451-a8cb-1b65a7456ba8', 2);
							INSERT INTO UserRoles (UserId, RoleId) VALUES ('70f74d66-896b-4401-b433-df93563a0738', 3);
        ...
        {
            migrationBuilder.Sql("DROP PROCEDURE [dbo].[usp_ReseedCloudAcctgTestDb]");
        }
    }
}
