...
public class RetrieveAllByAccountQueryHandler(
    IChartOfAccountRepository repository,
    ILogger<RetrieveAllByAccountQueryHandler> logger
) : IQueryHandler<RetrieveAllByAccountQuery, PagedResponse<ChartOfAccountDto>>
{
    public async Task<Result<PagedResponse<ChartOfAccountDto>>> Handle(RetrieveAllByAccountQuery query,
